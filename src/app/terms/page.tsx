...
export const metadata = {
  title: "ব্যবহারের শর্তাবলী | হ্যালো প্রবাস",
  description: "হ্যালো প্রবাস ওয়েবসাইট ব্যবহারের শর্তাবলী এবং নিয়মাবলী",
};
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-800">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-lg leading-relaxed mb-6">
                  হ্যালো প্রবাস ওয়েবসাইট ব্যবহার করার মাধ্যমে আপনি এই শর্তাবলী মেনে নিতে সম্মত হচ্ছেন। অনুগ্রহ করে সাবধানে পড়ুন।
                </p>
                ...
                <p>
                  হ্যালো প্রবাস একটি অনলাইন সংবাদ প্ল্যাটফর্ম যা প্রবাসী বাংলাদেশীদের জন্য সংবাদ, তথ্য এবং বিনোদন কন্টেন্ট প্রদান করে। আমরা আমাদের সেবা যে কোনো সময় পরিবর্তন বা বন্ধ করার অধিকার সংরক্ষণ করি।
                </p>
                ...
                <p>
                  হ্যালো প্রবাস ওয়েবসাইটের সকল কন্টেন্ট, লোগো, ডিজাইন এবং অন্যান্য উপাদান আমাদের বা আমাদের লাইসেন্সদাতাদের সম্পত্তি এবং কপিরাইট আইন দ্বারা সুরক্ষিত।
                </p>
                <p>
                ...
                <p>
                  হ্যালো প্রবাস "যেমন আছে" ভিত্তিতে সেবা প্রদান করে। আমরা নিশ্চয়তা দিই না যে:
                </p>
                <ul>
